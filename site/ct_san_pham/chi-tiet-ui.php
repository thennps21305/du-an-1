    ...
    <div class=" container product-detail my-1 pt-4 shadow-none">
      <div class="row mb-4">
        ...
        <div class="small-img-group col-lg-1 p-0 d-flex flex-column gap-1">
          <img
            src="https://images.unsplash.com/photo-1667597952986-55f637cf69dd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80"
            alt=""
            srcset=""
            height="18%"
            width="85%"
        ...
        <div class="col-lg-6 ps-4">
          <h3 style="color: #5f5959" class="fw-bold fs-2 mb-lg-4">
            <?=$ten_hh ?>
          </h3>
          <p class="price fw-bold fs-3 mb-lg-4 text-dark"><?=number_format($don_gia,0,",",".")."đ" ?> </p>
          <div class="pick-size d-flex align-items-center d-flex gap-4 mb-4">
            <p class="fs-4 m-0 fw-bold">Size:</p>
            <div class="group-btn-size d-flex gap-3">
              <button
                style="width: 40px"
          ...
          <div class="quantity-container d-flex align-items-center gap-4 mb-4">
            <p class="fs-4 m-0 fw-bold">Số lượng:</p>
            <div class="buy-amount">
              <span onclick="handleMinus()" class="btn-minus"
                ><i class="fa-solid fa-minus"></i
              ></span>
              <input class="text-center input-amount" type="number" value="1" />
          ...
          <button class="btn-add-cart mb-4">Thêm vào giỏ hàng</button>

          <div class="description mt-4">
            <h3 class=" fs-4 fw-bold ">Mô tả:</h3>
      ...
      <div class="size-guide row">
        <h3 class="fs-4 fw-bold mt-4 mb-4">Bảng size:</h3>
        <p>

        ...
        <div class=" panel panel-default shadow-none mt-4">
            <h3 style="background-color: #E0E0E0;" class="fw-bold p-3 rounded-top  fs-4 p-0 ">Bình Luận:</h3>
            ...
            <?php
                if(!isset($_SESSION['user'])){
                    echo '<b class="text-danger text-center mg-auto d-block fw-bold fs-5 rounded-bottom ">Đăng nhập để bình luận về sản phẩm này</b>';
                }else{
            ?>
